...
dir = os.path.dirname("C:\\Users\\KIIT\\PycharmProjects\\ANPR")


for img in glob.glob("C:\\Users\\KIIT\\PycharmProjects\\ANPR\\Dataset\\*.jpeg"):
    print(img)
    img = cv2.imread(img)
    # process the image here


# dir_path = "C:\\Users\\KIIT\\PycharmProjects\\ANPR\\test_images\\"
# for img_path in glob.glob(dir_path + "*.jpg"):
#     img = cv2.imread(img_path)
#     number_plate_text = number_plate_detection(img)
...
#         print("Number plate not detected.")
    ...
    res2 = "".join(re.split("[^a-zA-Z0-9]*", number_plate))
    res2 = res2.upper()
    array.append(res2)
...
# Searching
for img in glob.glob("C:\\Users\\KIIT\\PycharmProjects\\ANPR\\Search_Image\\*.jpeg"):
    img = cv2.imread(img)

    number_plate = number_plate_detection(img)
    #print("My number plate ")
    #print(number_plate)
